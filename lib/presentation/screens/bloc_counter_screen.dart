...
class BlocCounterScreen extends StatelessWidget {
  static const name = 'bloc_counter_screen';
    ...
    return Scaffold(
      ...
      body: Center(
        child: context.select(
          (CounterBloc bloc) => Text('Value: ${bloc.state.counter}'),
        ),
      ),
      floatingActionButton: Column(
        ...
        children: [
          ...
          FloatingActionButton(heroTag: '2', child: const Text('+2'), onPressed: () => increaseCounterBy(context, 2)),
          const SizedBox(height: 15),
          FloatingActionButton(heroTag: '3', child: const Text('+1'), onPressed: () => increaseCounterBy(context, 1)),
        ],
      ),
    );
  }
